            ...
            <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-12 gap-6">
                ...
                <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div className="glass-card rounded-3xl p-8 flex flex-col justify-between sm:col-span-2 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 -mr-16 -mt-16 w-64 h-64 bg-cyan-500/20 rounded-full blur-3xl group-hover:bg-cyan-500/30 transition-all duration-700"></div>
                        <div>
                            <h1 className="text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500 mb-2">STERA</h1>
                            <p className="text-gray-400 text-lg">Mental Health Monitoring System</p>
                        </div>
                        <div className="mt-12">
                    ...
                    <div className="glass-card rounded-3xl p-8 h-full flex flex-col justify-center relative overflow-hidden">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6 relative z-10">
                            ...
                            <button
                                type="submit"
                                disabled={loading}
                                className="w-full py-4 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-lg shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/50 transition-all transform hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
                            >
